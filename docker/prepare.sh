...
docker exec -it base-laravel-frontend bash -c "npm i -D vuetify vite-plugin-vuetify"
docker exec -it base-laravel-frontend bash -c "npm i @mdi/font"
docker exec -it base-laravel-frontend bash -c "npm install vuetify@next"
docker exec -it base-laravel-frontend bash -c "i18next"
